window.__dashboard = class {
    async main() {
        let dbes = await window.sr._("CorporateMeasures.comDashboardEntryFindall", null, {
            Enabled: true,
            Dashboard: {
                Enabled: true,
                User: window.me
        ...
        for (var i = 0; i < dbes.length; i++) {
            ...
            de.Data = await rs._run(de.GroupView.Name);
        }
