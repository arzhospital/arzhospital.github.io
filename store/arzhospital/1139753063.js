...
var server_time = new Date(2019, 7-1, 13, 4, 49, 42);

var execution_time = 0.046346;


var ret = new Array();
ret = new Array();
ret[0] = new Object();
ret[0].ToString = "Emp_Status";
ret[0]._ToString = "Emp_Status";
ret[0].Active = true;
ret[0].CodeField = "Emp_Status";
ret[0].NameField = "";
ret[0].Id = 187;
ret[0].DataMapid = 14;
...
ret[0].Group.ToString = "Employee Status";
ret[0].Group._ToString = "Employee Status";
ret[0].Group.Active = true;
ret[0].Group.Code = "EMPS";
ret[0].Group.Date = new Date(2018, 3-1, 18, 19, 13, 6);
ret[0].Group.Name = "Employee Status";
ret[0].Group.Order = 0;
ret[0].Group.Id = 37;
