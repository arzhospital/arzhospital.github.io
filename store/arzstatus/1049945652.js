...
var server_time = new Date(2019, 10-1, 19, 9, 39, 38);

var execution_time = 0.054838;


var ret = new Array();
ret = new Array();
ret[0] = new Object();
ret[0].ToString = "Total Room $";
ret[0]._ToString = "Total Room $";
ret[0].Active = true;
ret[0].Code = "TotalBONCC";
ret[0].Date = new Date(0001, 1-1, 1, 0, 0, 0);
ret[0].Enabled = true;
ret[0].Name = "Total Room $";
ret[0].Order = 0;
ret[0].Remark = "";
ret[0].Id = 36;
ret[0].Measureid = 0;
